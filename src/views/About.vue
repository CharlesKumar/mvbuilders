    ...
    <div class="c">
      ...
      <p class="para d-center">
        <span
          ...
          construction in a
          <span class="ttu fz-120p c-green">green</span> expansive environment.
          Our immense experience in apartment building with affordable price
          range attracts buyers from all parts of the world. We also provide
          clear title and legal opinion from eminent lawyers. Our floor plans
          are always VASTU compliant. Our impressive sense of architecture
          comprises of day light and ventilation optimization. We are well known
          for utilizing quality tools in our construction, employing skilled
          workers and delivering quality jobs to provide complete housing
          solutions.</span
        >
      </p>
      <div class="row">
      ...
      <div class="row page-break">
        <div class="col-md2">
          ...
          <ul class="list-checked">
            <li>
              <span
                >Government approved flats with (mandatory) RERA
                registration</span
              >
            </li>
            <li>
